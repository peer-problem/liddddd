...
public enum LidddddConstants {
  public static let productName = "Liddddd"
  ...
  public static let minimumBatteryFloor = 10
  public static let maximumBatteryFloor = 30

  public static let temperatureCutoffCelsius = 90.0
}
